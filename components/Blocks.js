                ...
                <div className="flex flex-wrap -m-4">
                    ...
                    <div onClick={()=> handleClick('Random Chess Engine', 'random')} className="cursor-pointer p-4 md:w-1/3 hover:shadow-2xl">
                        <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            <img className="lg:h-48 md:h-36 w-full object-cover object-center" src="random_ai.png" alt="blog" />
                            <div className="p-6">
                    ...
                    <div onClick={()=> handleClick('Trained ML Model', 'ml-model')} className="cursor-pointer p-4 md:w-1/3 hover:shadow-2xl">
                        <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            <img className="lg:h-48 md:h-36 w-full object-contain object-center" src="mlchess.webp" alt="blog" />
                            <div className="p-6">
                    ...
                    <div onClick={()=> handleClick('StockFish Chess Engine', 'stockfish')} className="cursor-pointer p-4 md:w-1/3 hover:shadow-2xl ">
                        <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                            <img className="lg:h-48 md:h-36 w-full object-center object-contain " src="stockfish.png" alt="blog" />
                            <div className="p-6">
